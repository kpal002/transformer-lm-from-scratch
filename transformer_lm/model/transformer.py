...
class TransformerBlock(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            use_gdn:     Use Gated Delta Net (Yang et al. 2024).
        """
        super().__init__()
        ...
        self.attn = CausalMultiHeadSelfAttention(
            d_model, num_heads, max_seq_len, theta, use_rope, use_flash, use_gdn, device, dtype
        )
    ...
    def __init__(
        ...
        self.blocks = nn.ModuleList([
            TransformerBlock(
                ...
                theta, norm_type, use_rope, use_flash, use_gdn, device, dtype
            )
